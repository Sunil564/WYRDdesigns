    ...
    >
      <motion.div style={{ x: springX, y: springY }}>
        <Link
          ...
          className="label rounded-pill bg-signal text-void hover:bg-signal-dim inline-flex min-h-11 items-center px-8 py-4 font-bold transition-colors duration-[var(--dur-fast)]"
        >
