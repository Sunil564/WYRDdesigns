...
| `public/brand/wyrd-watermark.webp` | 2101 x 989 | The white artwork at source resolution, for the footer's closing mark. Its alpha also serves as the mask for the sheen, so there is no separate mask file |
